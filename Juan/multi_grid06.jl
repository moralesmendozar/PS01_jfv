...
function multi_grid(economy, steadyState, nMidPoints::Array)
    ...
    for iGrid in 1:length(nMidPoints)
        ...
        # 3.1. Grid Capital
        # ----------------
        vGridCapital = exercise7aux.gridmake(capitalMinimum, capitalMaximum, nMidPoints[iGrid])
        nGridCapital = length(vGridCapital)

        # -----------------
        # 3.2. Pre-allocation
        # -----------------
        tValueFunction = fill(utilitySteadyState, nGridCapital, nGridZ, nGridA)
